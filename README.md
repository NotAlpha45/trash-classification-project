...
|---|---:|---:|---:|---:|
| Image Only (MobileNetV3) | 72.16% | 0.7150 | 0.7208 | 0.25 ms/sample |
| Text Only (DistilBERT) | 77.23% | 0.7711 | 0.7735 | 1.20 ms/sample |
| Multimodal Fusion (alpha = 0.70) | **81.14%** | **0.8080** | **0.8115** | 1.46 ms/sample |
...
| traditional | 81.14% | 0.8080 | 0.8206 |
...
- `results/phase2/paper_main_results.csv`
- `results/phase2/paper_main_results.tex`
- `results/phase2/key_findings_phase2.txt`
- `results/phase2/tuned_vs_fixed_alpha_summary.csv` (generated when `EVAL_MODE="both"` in `05_results_summary.ipynb`)
- `figures/phase2/*.png`

Notable summary figures generated by `notebooks/phase2/05_results_summary.ipynb` include:

- `figures/phase2/imbalance_overall_macro_f1.png`
- `figures/phase2/effectiveness_vs_efficiency.png`
- `figures/phase2/per_class_f1_delta_vs_traditional.png`
